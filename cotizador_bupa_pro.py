...
with t4:
    ...
    if not planes_seleccionados:
        ...
        with wa2:
            if "modo_wa" not in st.session_state or st.session_state["modo_wa"] == "Un solo plan": st.session_state["modo_wa"] = "Comparativa (todos los seleccionados)"
            modo = st.radio("Modo", ["Comparativa (todos los seleccionados)", "Un solo plan"], index=0, key="modo_wa")
